...
export const sendEventReminder = async (req, res) => {
    try {
        ...
        res.status(200).json({ success: true, message: `Reminder sent to ${name} successfully!` });
    } catch (error) {
...
export const sendPasswordReset = async (req, res) => {
    try {
        ...
        res.status(200).json({ success: true, message: `Password reset link sent to ${name} successfully!` });
    } catch (error) {
